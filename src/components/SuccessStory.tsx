      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-4">
            <div className="inline-block bg-primary-5/10 text-primary-5 px-4 py-2 rounded-full text-sm mb-4">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8 md:p-10">
                <h3 className="text-neutral-10 mb-6">
                  "From Concept to Production in 120 Days"
                </h3>
                
                <div className="space-y-6">
                  <div>
                    <div className="text-sm text-primary-5 mb-2">Challenge</div>
                  ...
                  <div>
                    <div className="text-sm text-primary-5 mb-2">Our Solution</div>
                    <p className="text-gray-600">
                  ...
                  <div>
                    <div className="text-sm text-primary-5 mb-2">Result</div>
